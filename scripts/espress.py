...
for user in users:
	...
	for i in interest_info_dict:
		...
		print(d['entries'][0]['published'][:-13])
		print(d['entries'][1]['published'][:-13])
		print(d['entries'][2]['published'][:-13])
		print(d['entries'][3]['published'][:-13])
		print(d['entries'][4]['published'][:-13])
