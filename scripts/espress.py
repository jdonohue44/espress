...
emails = []
test_file= open('/home/ec2-user/espress/dbtest.log','a')
...
for user in cur.fetchall():
	...
	cur.execute("SELECT USER_INTERESTS.Interest_ID FROM USER_INTERESTS WHERE USER_INTERESTS.User_ID = %d;", (int(user[0])))
