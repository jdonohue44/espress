...
for user in cur.fetchall():
	...
	for i in iid:
		...
		html += "<div style='text-align:center; padding: 10px; border-style: solid; border-radius: 4px; border-width: 1px; border-color: #c5c5c5;'><b style='font-size:16px;'>" + iid[i]['title'] + "</b></div>"
