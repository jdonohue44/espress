...
for user in cur.fetchall():
	...
	for i in iid:
		...
		html += "<div style='text-align:right; padding-top: 6px;'><a style='padding:6px; font-size: 16px; border-style: solid; border-width: 1px;' href ='" + iid[i]['link'] + "'>Read Article</a></div>"
		html += "</td></tr>"
	html += f2.read()
